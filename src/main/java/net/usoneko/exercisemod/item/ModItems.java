package net.usoneko.exercisemod.item;
...
import net.usoneko.exercisemod.ExerciseMod;
import net.usoneko.exercisemod.item.custom.MetalDetectorItem;

public class ModItems {
	public static final DeferredRegister<Item> ITEMS = 
			DeferredRegister.create(ForgeRegistries.ITEMS, ExerciseMod.MOD_ID) ;
